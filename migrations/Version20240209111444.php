 ...
 */
final class Version20240209111444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jour CHANGE nom nom VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jour CHANGE nom nom DATE NOT NULL');
    }
}
